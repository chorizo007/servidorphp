...
<body>
    <div class="nav">
        <button><a href="listarcupones.php">listar tus cupones</a></button>
        <?php
            if (!isset($_SESSION['admin'])) {
                echo "<button><a href='adminpremios.php'>admin premios</a></button>";
                echo "<button><a href='anularcupones.php'>admin cupones</a></button>";
                echo "<button><a href='asignarcupones.php'>asginar cupones</a></button>";
                echo "<button><a href='todospremios.php'>listar todos los premios</a></button>";
            }
